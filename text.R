evOverview <- paste("This map displays the United States export values in",
                    " millions of dollars. It defines which regions have a",
...
evAnalysis <- paste("Based on the export value map, the top three exporting ",
                    "regions are California, Texas, and New York. From these",
                    " three regions, New York seems to have a greater 2017 share",
                    "value, 15.4462, compared to the other two regions. In second place in Texas",
                    ...
                    " noticed was that a cluster of regions in the midwest and most of the",
                    " western side of the U.S. has a lower export value in contrast to the",
                    " Northeast and Southeast of the U.S.")

prodOverview <- paste("This map displays regions that export the same product. ",
...
prodAnalysisP1 <- paste("In reference to the Exporting Products map, our team discerned",
                        ...
                        " and parts. This product is exported from 16 different regions. ")
...
prodAnalysisP2 <- paste(" reports that the top countries to import this specific product",
                        ...
                        " other regions: New Jersey, Mississippi, and Louisana. While New York is the only",
